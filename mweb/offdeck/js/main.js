...
TresAd.prototype.events = function() {
  ...
  el.of('form').addEventListener('submit', function(e) {
    ...
    if (/\S/.test(nama) && /\S/.test(umur) && /\S/.test(no) && /\S/.test(kota) &&
        ...
        var url = '//www.mobileads.com/api/save_lf?contactEmail=jeff@mobileads.com,adhie@mobileads.com,dickale@imx.co.id,karima@imx.co.id&gotDatas=1&element=[{%22fieldname%22:%22text_4%22,%22value%22:%22'+nama+'%22},'+
        '{%22fieldname%22:%22text_5%22,%22value%22:%22'+umur+'%22},'+
        '{%22fieldname%22:%22text_6%22,%22value%22:%22'+no+'%22},'+
        '{%22fieldname%22:%22text_7%22,%22value%22:%22'+kota+'%22}]&user-id=2901&studio-id=239&tab-id=1&trackid=2111&referredURL=Sample%20Ad%20Unit&callback=leadGenCallback'
