...
TresAd.prototype.events = function() {
  ...
  el.of('form').addEventListener('submit', function(e) {
    ...
    if (/\S/.test(nama) && /\S/.test(umur) && /\S/.test(no) && /\S/.test(kota) &&
        ...
        '{%22fieldname%22:%22text_4%22,%22value%22:%22'+kota+'%22}]&user-id=2901&studio-id=238&tab-id=1&trackid=2110&referredURL=Sample%20Ad%20Unit&callback=leadGenCallback'
